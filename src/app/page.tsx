  ...
  return (
    <main className="min-h-dvh overflow-hidden bg-background text-foreground">
      <section className="relative isolate flex min-h-dvh items-center px-5 py-6 sm:px-8 lg:px-12">
        ...
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(rgba(34,211,238,0.07)_1px,transparent_1px),linear-gradient(90deg,rgba(217,70,239,0.06)_1px,transparent_1px)] bg-[size:34px_34px] opacity-45" />
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div className="flex flex-col gap-7">
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
              {strengths.map((strength) => (
                <div
                  className="rounded-2xl border border-cyan-300/15 bg-slate-950/55 px-3 py-3 text-sm font-semibold text-cyan-50 shadow-[inset_0_0_18px_rgba(34,211,238,0.06)]"
                  key={strength}
                >
                  {strength}
                </div>
